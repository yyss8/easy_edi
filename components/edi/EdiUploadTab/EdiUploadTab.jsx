...
const UploadTabContent = props => {
	switch (props.fileType) {
		...
		case 'archive':
			return <Table loading={props.tabLoading} dataSource={props.files} columns={props.fileColumns} rowSelection={ props.tableRowSelection } size="middle" />;
		...
		<Row style={{marginBottom: 10}}>
			<Col span={ 18 }>
				<Row>
					...
					{ props.fileType === 'archive' && <EdiTableFilters sorting={props.sorting} keyword={props.keyword} onRefresh={props.onRefresh} filterOnchange={props.filterOnchange} /> }
				</Row>
			</Col>
			{
